...
execute as @s[tag=!esc.on_boat, scores={esc.mount_cooldown=0}] at @s positioned ~-1 ~-0.5 ~-1 if entity @e[dx=1, dy=1, dz=1, type=#explosive_scube:all_boat] run function explosive_scube:mount_boat/mount
